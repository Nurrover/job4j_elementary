...
class TwoNumberSumTest {
    ...
    @Test
    void whenTwoEqualsNumbersNoTargetTwoVersion() {
        int[] array = {5, 5};
        int target = 12;
        int[] result = TwoNumberSum.getIndexesVersionTwo(array, target);
        int[] expected = {};
        assertThat(result).isEqualTo(expected);
    }

    @Test
    void whenWithNegativeNumbersYesTargetTwoVersion() {
        int[] array = {-7, -5, 0, 5, 8, 12};
        int target = 3;
        int[] result = TwoNumberSum.getIndexesVersionTwo(array, target);
        int[] expected = {1, 4};
    ...
    @Test
    void whenWithoutNegativeNumbersYesTargetTwoVersion() {
        int[] array = {0, 2, 5, 8, 10, 12};
        int target = 15;
        int[] result = TwoNumberSum.getIndexes(array, target);
        int[] expected = {2, 4};
